...
def map():
    ...
    if col1.button('Georgia Counties Votes Map'):
        ...
        [hello](https://hieppham.s3.us-east-2.amazonaws.com/Final_project/georgia/Georgia+vs+South+Carolina+Total+Votes.html)
    if col2.button('Georgia Counties Population Map'):
        ...
        [test](https://hieppham.s3.us-east-2.amazonaws.com/Final_project/georgia/Georgia+vs+South+Carolina+Population.html)
def DEM_vs_REP():
    #fig, ax = plt.subplots()
